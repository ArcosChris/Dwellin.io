    ...
    return (
        <div className="srcontainer">
            <h1 className="service text-center">Service Request
                <img className="image" width="100px" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQh2QVklNtRaXvWoiVDCE27akhKfTkhrCk0Mw&usqp=CAU" alt="" /> </h1>
            ...
            <div style={{ paddingLeft: "50px", paddingRight: "50px" }}>
                <Form>
                    ...
                    <Button className="buttonholder text-align-center d-block mx-auto" variant="light" type="submit">
                        Submit
                    </Button>
                </Form>
            </div>
